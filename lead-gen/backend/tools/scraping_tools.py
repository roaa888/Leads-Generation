...
@tool("contact_page_scraper")
def contact_page_scraper(base_url: str):
    """Look for contact pages and extract decision-maker contact details."""
    contact_paths = ['/contact', '/contact-us', '/about/contact', '/about', '/team', '/about-us', '/get-in-touch']
    ...
    return "No contact details found on common contact paths."
